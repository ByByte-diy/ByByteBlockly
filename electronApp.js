...
function createWindow () {
	mainWindow = new BrowserWindow({
		width: 1240,
		height: 700,
		icon: getStaticPath('media/app.ico'),
		frame: false,
		movable: true,
...
function createTerm() {
	...
	termWindow.loadFile(getStaticPath('term.html'))
...
function createRepl() {
	...
	termWindow.loadFile(getStaticPath('repl.html'))
	termWindow.setMenu(null)
	termWindow.on('closed', function () { 
		termWindow = null 
	})
...
function createfactory() {
	...
	factoryWindow.loadFile(getStaticPath('factory.html'))
...
function promptModal(options, callback) {
	...
	promptWindow.loadFile(getStaticPath('modalVar.html'))
