...
export const repeatBlock = new BlockBuilder("controls_repeat")
  ...
  .setTags(["logic", "loop"])
  .addDummyInput("REPEAT_DUMMY", "%{BKY_CONTROLS_REPEAT_MSG_REPEAT}")
  .addValueInput("TIMES", null, "Number")
  .setShadowBlock("math_number", { NUM: 5 })
  .addDummyInput("REPEAT_DUMMY_TIMES", "%{BKY_CONTROLS_REPEAT_MSG_TIMES}")
  .addStatementInput("DO")
  .setPreviousStatement(true)
  .setNextStatement(true)
  .setTooltip("%{BKY_CONTROLS_REPEAT_TOOLTIP}")
  .setHelpUrl(
