...
export const translations = {
  ...
  CAT_COMMUNICATION_SERIAL: "ℹ️ USB Serial",
  CAT_COMMUNICATION_SOFTSERIAL: "ℹ️ Soft Serial",
  CAT_COMMUNICATION_BLUETOOTH: "🔵 Bluetooth",
  CAT_COMMUNICATION_REMOTE: "🕹️ Пульт",
